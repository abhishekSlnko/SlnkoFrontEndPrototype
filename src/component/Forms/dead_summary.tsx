...
import { useGetDeadLeadsQuery, useGetInitialLeadsQuery, useGetLeadsQuery, useGetWarmLeadsQuery, useGetWonLeadsQuery } from "../../redux/leadsSlice";
...
const Dead_Summary = () => {
  ...
  const LeadId = localStorage.getItem("view_dead");
