...
import { useGetAcCableQuery } from "../../redux/Eng/acsSlice";
...
const ACCableTab = forwardRef((props, ref) => {
  const navigate = useNavigate();
    ...
    const { data: getLead = [], isLoading, error } = useGetAcCableQuery();
...
const filteredData = useMemo(() => {
    ...
    useImperativeHandle(ref, () => ({
      exportToCSV() {
        ...
        link.download =
          selected.length > 0 ? "Selected_AC Cable.csv" : "All_AC Cable.csv";
        link.click();
      },
    }));
          ...
          >
            <Grid container spacing={2}>
              ...
              <Grid xs={12} sm={6}>
                ...
                <Input
                  name="size"
                  value={selectedLead?.voltage_rating ?? ""}
                  readOnly
                  fullWidth
                />
              </Grid>
